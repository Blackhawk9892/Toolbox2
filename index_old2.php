    ...
    <body>
        ...
        if (isset($_POST['sign'])) {
            ...
            if ($missing == 0) {
                ...
                switch ($emp_position) {
                    case "sales":
                        $positionPage = 'sales/page_sales.php';
                        break;
                        case "Sales":
                            $positionPage = 'sales/page_sales.php';
                            break;  
                    case "service":
                        $positionPage = 'service/service_writer.php';
                        break;
                    case "finance":
                        $positionPage = '../sales/sales_appointments.php';
                        break;
                    case "manager":
                        $positionPage = 'sales/page_manager.php';                    
                        break;
                    case "mechanic":
                            $positionPage = 'public/page_home.php';                    
                            break;
                    case "photographer":
                        $positionPage = 'photo/page_photo.php';
                        break;
                    case "lot attendant":
                        $positionPage = 'sales/lot_attendant_board.php';
                        break;
                     case "lot":
                        $positionPage = 'public/page_lot_attendant.php';
                        break;
                    case "detailer":
                        $positionPage = 'service/dealer_detail_compl.php';
                        break;
                    case "receptionist":
                        $positionPage = 'public/mod_stocktag.php';
                        break;
                    case "call center":
                            $positionPage = 'sales/text_bdc_to_sales.php';
                            break;
                    case "bdc":
                                $positionPage = 'sales/text_bdc_to_sales.php';
                                break;
                    case "robotics":
                        $positionPage = 'public/page_robotics.php';
                        break;
